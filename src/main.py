...
chess_board = ["white_rook", "white_knight", "white_bishop", "white_queen", "white_king", "white_bishop", "white_knight", "white_rook",
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            if first_clicked_square is None and chess_board[clicked_square_index] != "empty_square":
